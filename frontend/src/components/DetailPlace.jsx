...
function DetailPlace({ placeId, onSuccess, placeRequestId, detailKey }) {
    ...
    console.log(placeId, 'place request id')
        ...
        try {
            await axios.get(`${import.meta.env.VITE_BACKEND_URL}/place-api/get-place/${id}`, { withCredentials: true })
                .then((res) => {
                    ...
                    setProvince(res.data.place.provinceId)
                    setDistrict(res.data.place.districtId)
    ...
    const handleUpdatePlace = async () => {
        ...
        try {
            ...
            await axios.put(`${import.meta.env.VITE_BACKEND_URL}/place-api/update`, formData, { withCredentials: true })
                .then((res) => {
    ...
    return (
        <div className='bg-transparent w-full'>
            ...
            <div className='flex justify-end mt-4'>
                <Button onClick={handleUpdatePlace} style={{ width: 150 }} size="large" type="primary" loading={isLoading}>แก้ไข</Button>
            </div>
