...
function PlaceRequest() {
    ...
    const handleTableChange = (pagination) => {
        getPlaceRequestPaginate(pagination.current, pagination.pageSize)
    }

    const getPlaceRequestPaginate = async (page = 1, pageSize = 5) => {
        try {
            await axios.get(`${import.meta.env.VITE_BACKEND_URL}/placeRequest-api/get-paginate?page=${page}&pageSize=${pageSize}&search=${search}`, { withCredentials: true })
                .then((res) => {
    ...
    useEffect(() => {
        getPlaceRequestPaginate(1, pagination.pageSize)
    }, [search])
    ...
    const deletePlaceRequest = async (id) => {
        ...
        try {
            console.log(id)
            await axios.put(`${import.meta.env.VITE_BACKEND_URL}/placeRequest-api/delete/${id}`, { detail }, { withCredentials: true })
                .then((res) => {
            ...
            <div className='bg-gray-200 w-full'>
                ...
                <div className='mt-5  flex justify-center'>
                    <div className=' px-3 pb-10 w-full lg:w-[80%]'>
                        <div className='text-md font-bold mb-5'>คำขอเพิ่มสถานที่ฝึกทั้งหมด</div>
